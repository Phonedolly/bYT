...
public class MainActivity extends Activity implements PopupMenu.OnMenuItemClickListener {
    ...
    private static class GeoPermissionRequest extends PermissionRequest {
        ...
        public String[] getResources() {
            return new String[] { MainActivity.RESOURCE_GEO };
        }

        public void grant(String[] resources) {
            assert resources.length == 1;
            assert MainActivity.RESOURCE_GEO.equals(resources[0]);
    ...
    private class FilePermissionRequest extends PermissionRequest {
        ...
        public String[] getResources() {
            return new String[] { MainActivity.RESOURCE_FILE_URL };
        }

        public void grant(String[] resources) {
            assert resources.length == 1;
            assert MainActivity.RESOURCE_FILE_URL.equals(resources[0]);
            // Try again now that we have read access.
            MainActivity.this.mWebView.loadUrl(mOrigin);
        }
    ...
    private void createAndInitializeWebView() {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                return startBrowsingIntent(MainActivity.this, url, allowLaunchingApps);
            }
        ...
        webview.setWebChromeClient(new WebChromeClient() {
            ...
            public void onPermissionRequest(PermissionRequest request) {
                MainActivity.this.requestPermissionsForPage(request);
            }
        });
